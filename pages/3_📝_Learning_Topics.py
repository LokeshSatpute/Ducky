...
learner_level = st.sidebar.selectbox("I'd like my answer as if I were a:",
                                     ["high school student", "college student", "adult", "retiree"])
...
topic = st.text_input("What would you like to learn about?", placeholder="Ask your coding related questions here.")
